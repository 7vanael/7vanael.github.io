...
## The Post: Getting Comfortable Submodules
...
You might start to consider using submodules if you're encountering the following: 
...
```
Depending on the size of your submodule project, this may take a moment to load, and maybe another minte for 
...
#### Helpful commands for investigating
...
I hope that after reading this brief you'll feel confident about using and troubleshooting them in your
own projects.
