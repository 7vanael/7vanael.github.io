...
var G__13575 = name_or_object;
if(speclj.config.load_reporter_by_name_QMARK_.call(null,name_or_object)){
return speclj.config.load_reporter_by_name.call(null,G__13575);
} else {
return G__13575;
}
});
...
var vec__13576 = speclj.config.parse_tag.call(null,tag);
var flag = cljs.core.nth.call(null,vec__13576,(0),null);
var value = cljs.core.nth.call(null,vec__13576,(1),null);
...
var _STAR_runner_STAR__orig_val__13579 = speclj.config._STAR_runner_STAR_;
var _STAR_reporters_STAR__orig_val__13580 = speclj.config._STAR_reporters_STAR_;
var _STAR_specs_STAR__orig_val__13581 = speclj.config._STAR_specs_STAR_;
var _STAR_color_QMARK__STAR__orig_val__13582 = speclj.config._STAR_color_QMARK__STAR_;
var _STAR_profile_QMARK__STAR__orig_val__13583 = speclj.config._STAR_profile_QMARK__STAR_;
var _STAR_omit_pending_QMARK__STAR__orig_val__13584 = speclj.config._STAR_omit_pending_QMARK__STAR_;
var _STAR_full_stack_trace_QMARK__STAR__orig_val__13585 = speclj.config._STAR_full_stack_trace_QMARK__STAR_;
var _STAR_tag_filter_STAR__orig_val__13586 = speclj.config._STAR_tag_filter_STAR_;
var _STAR_runner_STAR__temp_val__13587 = (cljs.core.truth_(new cljs.core.Keyword(null,"runner","runner",1945441304).cljs$core$IFn$_invoke$arity$1(config))?speclj.config.load_runner.call(null,new cljs.core.Keyword(null,"runner","runner",1945441304).cljs$core$IFn$_invoke$arity$1(config)):speclj.config.active_runner.call(null));
var _STAR_reporters_STAR__temp_val__13588 = (cljs.core.truth_(new cljs.core.Keyword(null,"reporters","reporters",-373999166).cljs$core$IFn$_invoke$arity$1(config))?cljs.core.mapv.call(null,speclj.config.load_reporter,new cljs.core.Keyword(null,"reporters","reporters",-373999166).cljs$core$IFn$_invoke$arity$1(config)):speclj.config.active_reporters.call(null));
var _STAR_specs_STAR__temp_val__13589 = new cljs.core.Keyword(null,"specs","specs",1426570741).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_color_QMARK__STAR__temp_val__13590 = new cljs.core.Keyword(null,"color","color",1011675173).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_profile_QMARK__STAR__temp_val__13591 = new cljs.core.Keyword(null,"profile","profile",-545963874).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_omit_pending_QMARK__STAR__temp_val__13592 = new cljs.core.Keyword(null,"omit-pending","omit-pending",-1591740250).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_full_stack_trace_QMARK__STAR__temp_val__13593 = (!((new cljs.core.Keyword(null,"stacktrace","stacktrace",-95588394).cljs$core$IFn$_invoke$arity$1(config) == null)));
var _STAR_tag_filter_STAR__temp_val__13594 = speclj.config.parse_tags.call(null,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(config));
(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__temp_val__13587);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__temp_val__13588);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__temp_val__13589);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__temp_val__13590);

(speclj.config._STAR_profile_QMARK__STAR_ = _STAR_profile_QMARK__STAR__temp_val__13591);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__temp_val__13592);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__temp_val__13593);

(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__temp_val__13594);

try{return action.call(null);
}finally {(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__orig_val__13586);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__orig_val__13585);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__orig_val__13584);

(speclj.config._STAR_profile_QMARK__STAR_ = _STAR_profile_QMARK__STAR__orig_val__13583);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__orig_val__13582);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__orig_val__13581);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__orig_val__13580);

(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__orig_val__13579);
}});
