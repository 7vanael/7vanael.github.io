...
var G__15062 = cljs.core.deref.call(null,component__$1.parent);
var G__15063 = (level + (1));
component__$1 = G__15062;
level = G__15063;
continue;
} else {
return level;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15064)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(speclj.reporting.yellow.call(null,"[FOCUS]"))].join('');
} else {
return G__15064;
}
});
...
return ["           ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15070)].join('');
} else {
return G__15070;
}
}));
...
var G__15074 = text;
if(cljs.core.truth_(speclj.config._STAR_profile_QMARK__STAR_)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(speclj.reporting.yellow.call(null,["[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(speclj.platform.format_seconds.call(null,result.seconds)),"s] "].join(''))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15074)].join('');
} else {
return G__15074;
}
}));
