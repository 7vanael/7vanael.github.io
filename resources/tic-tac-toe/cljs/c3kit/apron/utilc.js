...
return cljs.core.pr_str.call(null,G__12909);
}
});
/**
...
return cljs.core.reduce.call(null,(function (p1__12921_SHARP_,p2__12922_SHARP_){
return cljs.core.assoc.call(null,p1__12921_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__12922_SHARP_),p2__12922_SHARP_);
...
if(cljs.core.truth_((function (){var G__12959 = v;
if((G__12959 == null)){
return null;
} else {
return c3kit.apron.corec.not_blank_QMARK_.call(null,G__12959);
}
})())){
