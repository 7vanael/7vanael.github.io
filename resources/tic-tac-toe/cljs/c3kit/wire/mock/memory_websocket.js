...
var sock = this;
var G__14914 = c3kit.wire.socket.ready_state.call(null,sock);
switch (G__14914) {
case (0):
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14933),"/"].join('');
} else {
return G__14933;
}
});
...
return cljs.core.swap_BANG_.call(null,event_queue,cljs.core.update,event,(function (p1__14936_SHARP_){
return c3kit.apron.corec.removev.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([listener]),p1__14936_SHARP_);
}));
});
...
return cljs.core.run_BANG_.call(null,(function (p1__14944_SHARP_){
return c3kit.wire.mock.memory_websocket.attempt_handler.call(null,event,p1__14944_SHARP_);
}),handlers);
});
...
var obj14955 = ({"extensions":"","protocol":c3kit.wire.mock.memory_websocket.select_protocol.call(null,protocols),"url":c3kit.wire.mock.memory_websocket.normalize_url.call(null,url),"binaryType":"blob","removeEventListener":(function (event,listener){
...
var G__14970 = c3kit.wire.mock.memory_websocket.create_memory_socket.call(null,url,protocols);
c3kit.wire.mock.server.initiate.call(null,G__14970);
