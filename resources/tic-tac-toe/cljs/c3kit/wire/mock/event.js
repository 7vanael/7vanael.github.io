...
var G__9459 = e;
c3kit.apron.corec.oset.call(null,G__9459,"lastEventId","");

c3kit.apron.corec.oset.call(null,G__9459,"data",data);

c3kit.apron.corec.oset.call(null,G__9459,"ports",cljs.core.PersistentVector.EMPTY);

c3kit.apron.corec.oset.call(null,G__9459,"origin",cljs.core.re_find.call(null,/^wss?:\/\/[^\\/]*/,c3kit.apron.corec.oget.call(null,sock,"url")));

return G__9459;
});
c3kit.wire.mock.event.with_close_props = (function c3kit$wire$mock$event$with_close_props(e,code,reason,clean_QMARK_){
var G__9460 = e;
c3kit.apron.corec.oset.call(null,G__9460,"code",code);

c3kit.apron.corec.oset.call(null,G__9460,"reason",reason);

c3kit.apron.corec.oset.call(null,G__9460,"wasClean",clean_QMARK_);
...
var obj9462 = ({"eventPhase":(0),"cancelable":false,"currentTarget":element,"composed":false,"cancelBubble":false,"isTrusted":true,"returnValue":true,"timeStamp":cljs.core.js_invoke.call(null,performance,"now"),"bubbles":false,"target":element,"srcElement":element,"defaultPrevented":false});
return obj9462;
});
...
var G__9463 = c3kit.wire.mock.event.__GT_MemEvent.call(null,sock);
c3kit.apron.corec.oset.call(null,G__9463,"type","open");
...
var G__9464 = c3kit.wire.mock.event.__GT_MemEvent.call(null,sock);
c3kit.apron.corec.oset.call(null,G__9464,"type","close");

c3kit.wire.mock.event.with_close_props.call(null,G__9464,code,reason,clean_QMARK_);
...
var G__9465 = c3kit.wire.mock.event.__GT_MemEvent.call(null,sock);
c3kit.apron.corec.oset.call(null,G__9465,"type","message");

c3kit.wire.mock.event.with_message_props.call(null,G__9465,sock,data);
...
var G__9466 = c3kit.wire.mock.event.__GT_MemEvent.call(null,sock);
c3kit.apron.corec.oset.call(null,G__9466,"type","error");
