...
var len__5749__auto___15783 = arguments.length;
var i__5750__auto___15784 = (0);
while(true){
if((i__5750__auto___15784 < len__5749__auto___15783)){
args__5755__auto__.push((arguments[i__5750__auto___15784]));

var G__15787 = (i__5750__auto___15784 + (1));
i__5750__auto___15784 = G__15787;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.api.configure_BANG_.cljs$lang$applyTo = (function (seq15752){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15752));
}));

c3kit.wire.api.handle_payload = (function c3kit$wire$api$handle_payload(handler,payload){
try{return handler.call(null,payload);
}catch (e15785){var e = e15785;
...
var G__15794 = cljs.core.deref.call(null,c3kit.wire.api.config);
var G__15794__$1 = (((G__15794 == null))?null:new cljs.core.Keyword(null,"redirect-fn","redirect-fn",281458973).cljs$core$IFn$_invoke$arity$1(G__15794));
if((G__15794__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__15794__$1,uri);
}
});
...
c3kit.wire.api.handle_api_response = (function c3kit$wire$api$handle_api_response(raw_response,p__15801){
var map__15803 = p__15801;
var map__15803__$1 = cljs.core.__destructure_map.call(null,map__15803);
var handler = cljs.core.get.call(null,map__15803__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
var map__15804_15811 = c3kit.wire.apic.conform_response.call(null,raw_response);
var map__15804_15812__$1 = cljs.core.__destructure_map.call(null,map__15804_15811);
var status_15813 = cljs.core.get.call(null,map__15804_15812__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var flash_15814 = cljs.core.get.call(null,map__15804_15812__$1,new cljs.core.Keyword(null,"flash","flash",934660619));
var payload_15815 = cljs.core.get.call(null,map__15804_15812__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
var version_15816 = cljs.core.get.call(null,map__15804_15812__$1,new cljs.core.Keyword(null,"version","version",425292698));
var uri_15817 = cljs.core.get.call(null,map__15804_15812__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
if(cljs.core.seq.call(null,flash_15814)){
cljs.core.run_BANG_.call(null,c3kit.wire.flash.add_BANG_,flash_15814);
} else {
}

if(cljs.core.truth_((function (){var and__5023__auto__ = version_15816;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not_EQ_.call(null,version_15816,new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,c3kit.wire.api.config)));
} else {
return and__5023__auto__;
}
})())){
c3kit.wire.api.new_version_BANG_.call(null,version_15816);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ok","ok",967785236),status_15813)){
c3kit.wire.api.handle_payload.call(null,handler,payload_15815);
} else {
}

if(((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"redirect","redirect",-1975673286),status_15813)) && (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-redirect","no-redirect",-1477036586).cljs$core$IFn$_invoke$arity$1(options))))){
c3kit.wire.api.redirect.call(null,uri_15817);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1706214930),status_15813)){
var G__15806_15819 = options;
var G__15806_15820__$1 = (((G__15806_15819 == null))?null:new cljs.core.Keyword(null,"on-fail","on-fail",-589260753).cljs$core$IFn$_invoke$arity$1(G__15806_15819));
if((G__15806_15820__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__15806_15820__$1,payload_15815);
}
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_15813)){
var G__15809_15823 = options;
var G__15809_15824__$1 = (((G__15809_15823 == null))?null:new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__15809_15823));
if((G__15809_15824__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__15809_15824__$1,payload_15815);
}
} else {
}

var G__15810 = options;
var G__15810__$1 = (((G__15810 == null))?null:new cljs.core.Keyword(null,"after-all","after-all",-54883998).cljs$core$IFn$_invoke$arity$1(G__15810));
if((G__15810__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__15810__$1);
}
});
