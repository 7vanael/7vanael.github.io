...
var len__5749__auto___9502 = arguments.length;
var i__5750__auto___9503 = (0);
while(true){
if((i__5750__auto___9503 < len__5749__auto___9502)){
args__5755__auto__.push((arguments[i__5750__auto___9503]));

var G__9504 = (i__5750__auto___9503 + (1));
i__5750__auto___9503 = G__9504;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq9496){
var G__9497 = cljs.core.first.call(null,seq9496);
var seq9496__$1 = cljs.core.next.call(null,seq9496);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9497,seq9496__$1);
}));
...
var err_9508 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_9509 = (function (p1__9505_SHARP_){
var G__9507 = p1__9505_SHARP_;
...
if(cljs.core.truth_(level__GT_int_9509.call(null,x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.call(null,err_9508,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type.call(null,x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5025__auto__ = level__GT_int_9509.call(null,x);
...
var valid_level__GT_int_9513 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return (valid_level__GT_int_9513.call(null,x) >= valid_level__GT_int_9513.call(null,y));
});
var fn_QMARK__9523 = cljs.core.fn_QMARK_;
var compile_9524 = taoensso.encore.fmemoize.call(null,(function (x){
return taoensso.encore.name_filter.call(null,x);
}));
var conform_QMARK__STAR__9525 = taoensso.encore.fmemoize.call(null,(function (x,ns){
return compile_9524.call(null,x).call(null,ns);
}));
var conform_QMARK__9526 = (function (ns_filter,ns){
if(cljs.core.truth_(fn_QMARK__9523.call(null,ns_filter))){
return ns_filter.call(null,ns);
} else {
return conform_QMARK__STAR__9525.call(null,ns_filter,ns);
}
});
/**
 * Implementation detail.
...
if(cljs.core.truth_(conform_QMARK__9526.call(null,ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome.call(null,(function (p__9516){
var vec__9517 = p__9516;
var ns_pattern = cljs.core.nth.call(null,vec__9517,(0),null);
var min_level = cljs.core.nth.call(null,vec__9517,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__9525.call(null,ns_pattern,ns))){
...
var valid_level_9527 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_9528 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
return valid_level_9527.call(null,(function (){var or__5025__auto__ = ((cljs.core.vector_QMARK_.call(null,x))?ns__GT__QMARK_min_level_9528.call(null,x,ns):x);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return default$;
...
var ns_whitelist__$1 = leglist_9529.call(null,ns_whitelist);
var ns_blacklist__$1 = leglist_9529.call(null,ns_blacklist);
...
var level_GT__EQ__9534 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__9535 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_9536 = taoensso.timbre.get_min_level;
var legacy_ns_filter_9537 = taoensso.timbre.legacy_ns_filter;
/**
 * Implementation detail.
...
var min_level = get_min_level_9536.call(null,default_min_level,(function (){var or__5025__auto__ = cljs.core.get.call(null,config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
if(cljs.core.truth_(level_GT__EQ__9534.call(null,level,min_level))){
...
return legacy_ns_filter_9537.call(null,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774)),cljs.core.get.call(null,config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142)));
}
})();
if(cljs.core.truth_(temp__5823__auto__)){
var ns_filter = temp__5823__auto__;
if(cljs.core.truth_(may_log_ns_QMARK__9535.call(null,ns_filter,_QMARK_ns_str))){
return true;
} else {
return false;
}
...
}catch (e9543){if((e9543 instanceof Error)){
var e = e9543;
return e;
} else {
throw e9543;
...
var min_level_STAR___$1 = cljs.core.reduce.call(null,(function (acc,p__9544){
var vec__9545 = p__9544;
var ns_pattern = cljs.core.nth.call(null,vec__9545,(0),null);
var _pattern_min_level = cljs.core.nth.call(null,vec__9545,(1),null);
var entry = vec__9545;
...
var min_level_STAR___$2 = (function (){var temp__5823__auto__ = ((cljs.core._EQ_.call(null,cljs.core.count.call(null,min_level_STAR___$1),(1)))?(function (){var vec__9548 = min_level_STAR___$1;
var vec__9551 = cljs.core.nth.call(null,vec__9548,(0),null);
var ns_pattern = cljs.core.nth.call(null,vec__9551,(0),null);
var level = cljs.core.nth.call(null,vec__9551,(1),null);
...
var ret__5804__auto___9571 = (function (){
/**
...
return cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol("taoensso.timbre","swap-config!","taoensso.timbre/swap-config!",-923245809,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol("cljs.core","fn","cljs.core/fn",-1065745098,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec.call(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol(null,"config__9558__auto__","config__9558__auto__",1330860843,null),null,(1),null)))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,(new cljs.core.List(null,new cljs.core.Symbol("taoensso.timbre","set-ns-min-level","taoensso.timbre/set-ns-min-level",1904371957,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"config__9558__auto__","config__9558__auto__",1330860843,null),null,(1),null)),(new cljs.core.List(null,cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns),null,(1),null)),(new cljs.core.List(null,_QMARK_min_level,null,(1),null))))),null,(1),null))))),null,(1),null)))));
}));
...
var map__9573 = timestamp_opts;
var map__9573__$1 = cljs.core.__destructure_map.call(null,map__9573);
var pattern = cljs.core.get.call(null,map__9573__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var vec__9580 = vargs;
var v0 = cljs.core.nth.call(null,vec__9580,(0),null);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__9583 = vargs__$1;
var v0__$1 = cljs.core.nth.call(null,vec__9583,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__9586 = vargs__$1;
var v0__$1 = cljs.core.nth.call(null,vec__9586,(0),null);
return v0__$1;
})():null);
var vargs__$2 = ((fmt_msg_QMARK_)?taoensso.encore.vrest.call(null,vargs__$1):vargs__$1);
...
}catch (e9594){var t = e9594;
var map__9595 = data;
var map__9595__$1 = cljs.core.__destructure_map.call(null,map__9595);
var level = cljs.core.get.call(null,map__9595__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_ns_str = cljs.core.get.call(null,map__9595__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.call(null,map__9595__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var _QMARK_line = cljs.core.get.call(null,map__9595__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var _QMARK_column = cljs.core.get.call(null,map__9595__$1,new cljs.core.Keyword(null,"?column","?column",1004649085));
...
var instant_9609 = (new Date());
var context_9610 = taoensso.timbre._STAR_context_STAR_;
var vargs_9611 = cljs.core.deref.call(null,vargs_);
var vec__9603_9612 = taoensso.timbre.parse_vargs.call(null,_QMARK_err,msg_type,vargs_9611);
var _QMARK_err_9613__$1 = cljs.core.nth.call(null,vec__9603_9612,(0),null);
var _QMARK_meta_9614 = cljs.core.nth.call(null,vec__9603_9612,(1),null);
var _QMARK_msg_fmt_9615 = cljs.core.nth.call(null,vec__9603_9612,(2),null);
var vargs_9616__$1 = cljs.core.nth.call(null,vec__9603_9612,(3),null);
var data_9617 = cljs.core.conj.call(null,(function (){var or__5025__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891),new cljs.core.Keyword(null,"?column","?column",1004649085)],[instant_9609,spying_QMARK_,config,vargs_9616__$1,_QMARK_file,cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null),level),_QMARK_ns_str,level,msg_type,_QMARK_err_9613__$1,context_9610,_QMARK_line,_QMARK_meta_9614,_QMARK_msg_fmt_9615,_QMARK_column]));
var _QMARK_data_9618 = cljs.core.reduce.call(null,(function (acc,mf){
...
}),data_9617,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"middleware","middleware",1462115504)));
var temp__5825__auto___9619 = _QMARK_data_9618;
if(cljs.core.truth_(temp__5825__auto___9619)){
var data_9620__$1 = temp__5825__auto___9619;
var map__9606_9621 = data_9620__$1;
var map__9606_9622__$1 = cljs.core.__destructure_map.call(null,map__9606_9621);
var vargs_9623__$2 = cljs.core.get.call(null,map__9606_9622__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_9624__$2 = taoensso.encore.assoc_nx.call(null,data_9620__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
return taoensso.timbre.protected_fn.call(null,"Timbre error when calling (msg-fn <data>)",taoensso.timbre.default_output_msg_fn).call(null,data_9620__$1);
}),null)),new cljs.core.Keyword(null,"hash_","hash_",-827203612),(new cljs.core.Delay((function (){
return cljs.core.hash.call(null,(function (){var b2__1591__auto__ = cljs.core.get.call(null,_QMARK_meta_9614,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(b2__1591__auto__)){
var id = b2__1591__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,callsite_id,level], null);
} else {
var b2__1591__auto____$1 = cljs.core.get.call(null,_QMARK_meta_9614,new cljs.core.Keyword(null,"id!","id!",218090956));
if(cljs.core.truth_(b2__1591__auto____$1)){
var id = b2__1591__auto____$1;
return id;
} else {
var b2__1591__auto____$2 = cljs.core.get.call(null,_QMARK_meta_9614,new cljs.core.Keyword(null,"hash","hash",-13781596));
if(cljs.core.truth_(b2__1591__auto____$2)){
var h = b2__1591__auto____$2;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,callsite_id,_QMARK_msg_fmt_9615,level], null);
} else {
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [vargs_9623__$2,callsite_id,_QMARK_msg_fmt_9615,level], null);
}
}
}
})());
}),null)));
var get_timestamp_delay_9625 = (function (){var get_shared_delay = taoensso.encore.fmemoize.call(null,(function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp.call(null,opts,cljs.core.get.call(null,data_9624__$2,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
var get_output_fn_9626 = (function (){var base_fn = taoensso.encore.fmemoize.call(null,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
var base_output_opts_9627 = cljs.core.get.call(null,config,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return cljs.core.not.call(null,rl_fn.call(null,cljs.core.force.call(null,cljs.core.get.call(null,data_9624__$2,new cljs.core.Keyword(null,"hash_","hash_",-827203612)))));
}
})();
if(rate_limit_okay_QMARK_){
var map__9607 = appender;
var map__9607__$1 = cljs.core.__destructure_map.call(null,map__9607);
var apfn = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
var timestamp_ = get_timestamp_delay_9625.call(null,cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var output_fn = get_output_fn_9626.call(null,cljs.core.get.call(null,appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539)));
...
var map__9635 = data;
var map__9635__$1 = cljs.core.__destructure_map.call(null,map__9635);
var level = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var _QMARK_ns_str = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var output_opts = cljs.core.get.call(null,map__9635__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
 ...
 */
taoensso.timbre.default_output_msg_fn = (function taoensso$timbre$default_output_msg_fn(p__9645){
var map__9646 = p__9645;
var map__9646__$1 = cljs.core.__destructure_map.call(null,map__9646);
var data = map__9646__$1;
var msg_type = cljs.core.get.call(null,map__9646__$1,new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822));
var _QMARK_msg_fmt = cljs.core.get.call(null,map__9646__$1,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891));
var vargs = cljs.core.get.call(null,map__9646__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var output_opts = cljs.core.get.call(null,map__9646__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var map__9647 = output_opts;
var map__9647__$1 = cljs.core.__destructure_map.call(null,map__9647);
var arg__GT_str_fn = cljs.core.get.call(null,map__9647__$1,new cljs.core.Keyword(null,"arg->str-fn","arg->str-fn",2064845310),taoensso.timbre.default_arg__GT_str_fn);
var G__9648 = msg_type;
if(cljs.core._EQ_.call(null,null,G__9648)){
return "";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"p","p",151049309),G__9648)){
return taoensso.timbre.str_join.call(null,arg__GT_str_fn,vargs);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),G__9648)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9648)].join('')));
 ...
 */
taoensso.timbre.default_output_error_fn = (function taoensso$timbre$default_output_error_fn(p__9651){
var map__9652 = p__9651;
var map__9652__$1 = cljs.core.__destructure_map.call(null,map__9652);
var data = map__9652__$1;
var _QMARK_err = cljs.core.get.call(null,map__9652__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var output_opts = cljs.core.get.call(null,map__9652__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return taoensso.truss.impl._invar_violation_BANG_.call(null,true,new cljs.core.Symbol(null,"taoensso.timbre","taoensso.timbre",407940729,null),944,13,"/Users/kristikorn/projects/tic-tac-toe/resources/public/cljs/taoensso/timbre.cljc",new cljs.core.Keyword("taoensso.truss.impl","some?","taoensso.truss.impl/some?",1536228403),null,new cljs.core.Symbol(null,"?err","?err",-2104782470,null),_QMARK_err,e,null);
}
})();
var nl = "\n";
...
var args__5755__auto__ = [];
var len__5749__auto___9734 = arguments.length;
var i__5750__auto___9737 = (0);
while(true){
if((i__5750__auto___9737 < len__5749__auto___9734)){
args__5755__auto__.push((arguments[i__5750__auto___9737]));

var G__9739 = (i__5750__auto___9737 + (1));
i__5750__auto___9737 = G__9739;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq9694){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9694));
}));
